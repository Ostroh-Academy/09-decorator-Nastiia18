...
# Пояснення:
Цей код демонструє використання паттерна Декоратор для динамічного додавання функціональності до базового класу заводу. Він складається з трьох класів: абстрактного класу заводу, конкретного заводу, який виробляє цивільне обладнання, і декоратора, який розширює функціональність заводу, додаючи виробництво військового обладнання. У методі Main() створюється екземпляр конкретного заводу, до якого потім додається функціональність виробництва військового обладнання за допомогою декоратора.
